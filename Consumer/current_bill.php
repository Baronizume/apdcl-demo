    ...
    <div class="col-lg-6">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($user['consumer_no'] ?? $bill['consumer_no']) ?></td>
            </tr>

            <tr>
                <th>Consumer Name</th>
                <td><?= htmlspecialchars($user['name'] ?? $bill['consumer_name']) ?></td>
            </tr>

            <tr>
                <th>Father Name</th>
                <td><?= htmlspecialchars($user['father_name'] ?? 'N/A') ?></td>
            </tr>
            ...
            <tr>
                <th>Category</th>
                <td><?= htmlspecialchars($user['category'] ?? 'Domestic') ?></td>
            </tr>

            <tr>
                <th>Meter No</th>
                <td><?= htmlspecialchars($bill['meter_no'] ?? 'N/A') ?></td>
            </tr>

            <tr>
                <th>Zone</th>
                <td><?= htmlspecialchars($bill['zone'] ?? 'N/A') ?></td>
            </tr>

            <tr>
                <th>Circle</th>
                <td><?= htmlspecialchars($bill['circle'] ?? 'N/A') ?></td>
            </tr>

            <tr>
                <th>Sub-Division</th>
                <td><?= htmlspecialchars($bill['sub_division'] ?? 'N/A') ?></td>
            </tr>
...
<div class="col-lg-6">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($bill['bill_no'] ?? 'N/A') ?></td>
        </tr>

        <tr>
            <th>Billing Month</th>
            <td><?= htmlspecialchars($bill['month'] ?? 'N/A') ?></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <?= !empty($bill['bill_period_from'])
                    ? date("d-m-Y", strtotime($bill['bill_period_from']))
                    : 'N/A'; ?>

                -

                <?= !empty($bill['bill_period_to'])
        ...
        <tr>
            <th>Billing Days</th>
            <td><?= htmlspecialchars($bill['billing_days'] ?? '30') ?></td>
        </tr>

        <tr>
            <th>Supply Type</th>
            <td><?= htmlspecialchars($bill['supply_type'] ?? 'LT Supply') ?></td>
        </tr>

        <tr>
            <th>Supply Voltage</th>
            <td><?= htmlspecialchars($bill['supply_voltage'] ?? '230 V') ?></td>
        </tr>

        <tr>
            <th>Tariff Category</th>
            <td><?= htmlspecialchars($bill['tariff_category'] ?? 'Domestic') ?></td>
        </tr>

        <tr>
            <th>Meter Status</th>
            <td><?= htmlspecialchars($bill['meter_status'] ?? 'Normal') ?></td>
        </tr>
...
<div class="alert alert-primary mt-4">
    ...
    <strong>
        <?= htmlspecialchars($bill['amount_in_words'] ?? 'Amount in words not available') ?>
    </strong>
